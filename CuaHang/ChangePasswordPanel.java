...
public class ChangePasswordPanel extends JPanel {
    ...
    private String username; // Cần biết ai đang đổi mật khẩu
    ...
    public ChangePasswordPanel(ManageFrame frame, String username) {
        ...
        txtOldPass.setBorder(new RoundedBorder(10)); // Class viền bo tròn cũ của bạn
        ...
        try (Connection conn = db.getConnection()) {
            ...
            try (PreparedStatement psUpdate = conn.prepareStatement(updateSql)) {
                ...
                if (row > 0) {
                    ...
                    frame.showPersonPanel(); // Quay về màn hình chính
                }
            }
